  ...
  return (
    <div className="disclaimer">
        ...
        <p>
            ...
            Company (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer) refers to vaxbot.
            Service refers to the Website.
            You means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
            Website refers to vaxbot, accessible from https://www.vaxbot.org
        </p>
        <h2>Disclaimer</h2>
        <p>
            ...
            The content of the Service does not constitute any form of recommendation or medical advice.
        ...
        <h2>Contact Us</h2>
        <p>
            If you have any questions about this Disclaimer, You can contact Us by email: vaxbotstl@gmail.com
        </p>
    </div>
  );
}
